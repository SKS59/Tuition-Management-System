...
$Sub_id=$last_pay="";
 ...
 if($Student_name!="")
 {
  ...
  $sql=" INSERT into Enroll(Student_id,Subject_id,Enroll_date,Payment_id,image)
        Values('$str','$str2','$Enroll_date','$last_pay','$image')" ;
  $conn->exec($sql);
  ...
  ?>
  <script> alert("Succesfully Entered") </script>
  <?php
